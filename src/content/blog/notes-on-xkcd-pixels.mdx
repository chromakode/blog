...
import cornerCaseImg from './images/notes-on-xkcd-pixels/corner-case.png'
...
[![A couple sample zooms from Pixels](./images/notes-on-xkcd-pixels/pixels-zoom.png)](http://xkcd.com/1416/)
...
![Sample zooms labeled with pos and offset values](./images/notes-on-xkcd-pixels/pixels-pos-offset.png)
...
<Image class="tall" src={cornerCaseImg} alt="Zooming on a corner in Pixels" />
